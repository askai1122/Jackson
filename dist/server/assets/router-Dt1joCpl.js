import { P as reactExports, s as functionalUpdate$1, a as arraysEqual, g as createLRUCache, C as isPromise, E as isRedirect, B as isNotFound, x as invariant, f as createControlledPromise, Y as rootRouteId, F as isServer$1, d as compileDecodeCharMap, _ as trimPath, X as rewriteBasepath, e as composeRewrites, N as processRouteTree, M as processRouteMasks, W as resolvePath, c as cleanPath, a0 as trimPathRight, L as parseHref, n as executeRewriteInput, y as isDangerousProtocol, Q as redirect, r as findSingleMatch, i as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, b as buildRouteBranch, w as interpolatePath, K as nullReplaceEqualDeep, T as replaceEqualDeep$1, I as last, h as decodePath, p as findFlatMatch, q as findRouteMatch, v as hasKeys, o as executeRewriteOutput, k as encodePathLikeUrl, $ as trimPathLeft, G as joinPaths, a2 as useRouter, j as dummyMatchContext, J as matchContext, u as getDefaultExportFromCjs, U as requireReactDom, m as exactPathTest, S as removeTrailingSlash, R as React, H as jsxRuntimeExports, A as isModuleNotFoundError, a1 as useHydrated, l as escapeHtml, z as isInlinableStylesheet, t as getAssetCrossOrigin, V as resolveManifestAssetLink, O as Outlet } from "./server-ClcAR_vG.js";
...
const appCss = "/assets/styles-DbJO_iQG.css";
...
const Route$2 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Jackson Dental delivers concierge-level cosmetic, restorative, and family dentistry in Tampa, FL. Experience modern luxury care, transparent pricing, and award-winning smiles." },
      { name: "author", content: "Jackson Dental" },
      { property: "og:title", content: "Jackson Dental — Luxury Dentistry in Tampa" },
      { property: "og:description", content: "Concierge cosmetic, restorative, and family dentistry in Tampa, FL." },
...
const $$splitComponentImporter$1 = () => import("./admin-Cq2xlaOy.js");
const Route$1 = createFileRoute("/admin")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-BTRtY6zG.js");
